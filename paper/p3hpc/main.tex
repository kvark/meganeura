...
training outputs in the reported control. The updated harness records that
choice, retaining encoder compilation, graph replay, and numerical gates.\footnote{\href{https://github.com/kvark/inferena/blob/757f6a80b3dee2d6e9392fbbfc28e64febc9fe28/EXPERIMENT.md}{ROCm Whisper controls and reference policy, revision \code{757f6a8}}.}
This is a data-sensitive failure in the AMD vendor stack, not a setup
problem; the controls do not locate the underlying defect. These diagnostics
remain separate from the timing cohort, and the workaround still needs
paired qualification in both arithmetic contracts.
