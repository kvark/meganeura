...
path. The current collection retains 205 valid GPU pairs and reports
the 780M failure alongside its completed conditions.

PyTorch still leads most timing comparisons. Across seven fully replicated
strict configurations, median inference and training times are $1.85\times$
and $2.15\times$ PyTorch's. Broader graph and kernel search improves several
