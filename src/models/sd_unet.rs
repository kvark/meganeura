...
impl SDUNetConfig {
    ...
    /// Wide, conditioned latent-diffusion U-Net workload using a 384×256
    /// latent (3072×2048 pixels at f=8).
    ///
    ...
    /// timestep-conditioning structure match SD 1.x conventions.
    pub fn small() -> Self {
        Self {
            batch_size: 1,
            in_channels: 4,
