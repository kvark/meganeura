...
const RECORDS: [&[u8]; 6] = [
    include_bytes!("../docs/experiments/crossover-2026-09-06/run-01.json.gz"),
    include_bytes!("../docs/experiments/crossover-2026-09-06/run-02.json.gz"),
    include_bytes!("../docs/experiments/crossover-2026-09-06/run-03.json.gz"),
    include_bytes!("../docs/experiments/crossover-2026-09-06/run-04.json.gz"),
    include_bytes!("../docs/experiments/crossover-2026-09-06/run-05.json.gz"),
    include_bytes!("../docs/experiments/crossover-2026-09-06/run-06.json.gz"),
];
...
fn retained_crossover_runs_replay() {
    let records: Vec<Value> = RECORDS.iter().map(|s| archives::json(s)).collect();
