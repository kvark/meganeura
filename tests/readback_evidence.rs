...
const RECORDS: [&[u8]; PROCESSES] = [
    include_bytes!("../docs/experiments/readback-2026-09-06/run-01.json.gz"),
    include_bytes!("../docs/experiments/readback-2026-09-06/run-02.json.gz"),
    include_bytes!("../docs/experiments/readback-2026-09-06/run-03.json.gz"),
    include_bytes!("../docs/experiments/readback-2026-09-06/run-04.json.gz"),
    include_bytes!("../docs/experiments/readback-2026-09-06/run-05.json.gz"),
    include_bytes!("../docs/experiments/readback-2026-09-06/run-06.json.gz"),
];
...
fn retained_readback_runs_and_promotion_gates_replay() {
    let records: Vec<_> = RECORDS.iter().map(|s| archives::json(s)).collect();
