...
const RECORDS: [&[u8]; 3] = [
    include_bytes!("../docs/experiments/training-profile-2026-09-06/run-01.json.gz"),
    include_bytes!("../docs/experiments/training-profile-2026-09-06/run-02.json.gz"),
    include_bytes!("../docs/experiments/training-profile-2026-09-06/run-03.json.gz"),
];
