...
fn retained_scalar_tuning_runs_replay() {
    let records = [
        include_str!("../docs/experiments/tuning-2026-09-05/run-01.json"),
        include_str!("../docs/experiments/tuning-2026-09-05/run-02.json"),
        include_str!("../docs/experiments/tuning-2026-09-05/run-03.json"),
        include_str!("../docs/experiments/tuning-2026-09-05/run-04.json"),
        include_str!("../docs/experiments/tuning-2026-09-05/run-05.json"),
    ];
