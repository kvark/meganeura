...
const RECORDS: [&str; readback::PROCESSES] = [
    include_str!("../docs/experiments/staging-reuse-2026-09-06/run-01.json"),
    include_str!("../docs/experiments/staging-reuse-2026-09-06/run-02.json"),
    include_str!("../docs/experiments/staging-reuse-2026-09-06/run-03.json"),
    include_str!("../docs/experiments/staging-reuse-2026-09-06/run-04.json"),
    include_str!("../docs/experiments/staging-reuse-2026-09-06/run-05.json"),
    include_str!("../docs/experiments/staging-reuse-2026-09-06/run-06.json"),
];
