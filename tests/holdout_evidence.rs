...
const RECORDS: [&[u8]; 5] = [
    include_bytes!("../docs/experiments/holdouts-2026-09-06/run-01.json.gz"),
    include_bytes!("../docs/experiments/holdouts-2026-09-06/run-02.json.gz"),
    include_bytes!("../docs/experiments/holdouts-2026-09-06/run-03.json.gz"),
    include_bytes!("../docs/experiments/holdouts-2026-09-06/run-04.json.gz"),
    include_bytes!("../docs/experiments/holdouts-2026-09-06/run-05.json.gz"),
];
...
fn retained_holdout_runs_replay() {
    let records: Vec<Value> = RECORDS.iter().map(|text| archives::json(text)).collect();
...
fn unchanged_control_ratio_is_not_a_paired_gain() {
    let record: Value = archives::json(RECORDS[2]);
