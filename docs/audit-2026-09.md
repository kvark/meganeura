...
complete shader/geometry swaps. The [corrected six-process crossover](experiments.md#conv-tiles-corrected-2026-09-06)
...
These engineering experiments are separate from the frozen paper result set.

The subsequent [five-process transfer pilot](experiments.md#tuning-2026-09-05)
...
listed below; restore checks are in the [checkpoint implementation](../src/runtime/checkpoint.rs).
...
The [complete experiment](experiments.md#holdouts-2026-09-06) retains all
...
The [separate crossover cohort](experiments.md#crossover-2026-09-06)
...
The [readback protocol and six raw processes](experiments.md#readback-2026-09-06)
...
The [separate resource experiment](experiments.md#staging-reuse-2026-09-06)
...
The [three-process profile cohort](experiments.md#training-profile-2026-09-06),
...
is now closed after the [single bounded accumulation attempt](experiments.md#compensated-dw-2026-09-06):
...
The [bounded split-K prototype](experiments.md#split-k-2026-09-06) now
...
was claimed by that initial prototype. The [follow-up sequence cohort](experiments.md#split-k-sequence-2026-09-06)
...
First, finish the accepted paper using the frozen result set. No new benchmark
is required to make the present claims precise. For a separately scoped later engineering
...
The [experiment ledger](experiments.md) records designs and acceptance criteria.
The main strategic change is to make safe measured selection an early
infrastructure task, while resisting
