...
is claimed. The next engineering step is bounded isolated sequence qualification
and measurement with all scratch bytes charged, then rebuilt-session whole-step
confirmation; live tile swaps must continue rejecting incompatible layouts.
