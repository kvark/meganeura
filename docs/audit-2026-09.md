...
properties were measured. The next search-cost work is to separate private
allocation/cleanup and assess bounded reuse. Metal maps both staging policies
to shared storage, and cross-backend performance remains unmeasured.
...
readback evidence to profile preparation/allocation/cleanup before bounded reuse, and
