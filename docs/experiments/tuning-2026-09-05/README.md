...
output checks and raw whole-step samples. `Cargo.lock.gz` here preserves the exact
...
Raw evidence: [run 1](run-01.json.gz), [run 2](run-02.json.gz), [run 3](run-03.json.gz),
[run 4](run-04.json.gz), [run 5](run-05.json.gz). No runs were discarded.
